"""
Módulo de conexión centralizado - Sistema de Control de Pañol
================================================================
Centraliza los parámetros y la lógica de conexión a MongoDB para
evitar duplicar este bloque en cada módulo del CRUD (Agregar_Eliminar,
Actualizar, Consultas). Si alguna vez cambia el host, el puerto o el
nombre de la base de datos, solo se modifica en un único lugar.
"""
import sys
import pymongo
